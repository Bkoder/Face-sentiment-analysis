...
face_classifier = cv2.CascadeClassifier(r'D:\Project\face sentiment analysis\haarcascade_frontalface_default.xml')
classifier = load_model(r'D:\Project\face sentiment analysis\Emotion_little_vgg.h5')
